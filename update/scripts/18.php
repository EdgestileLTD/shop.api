...
se_db_add_field('shop_coupons', 'payment_id', "int(10) unsigned DEFAULT NULL");
se_db_add_field('shop_coupons', 'only_registered', "enum('Y','N') NOT NULL DEFAULT 'N'");


se_db_add_field('shop_deliverytype', 'time_to', "time DEFAULT NULL");
se_db_add_field('shop_deliverytype', 'time_from', "time DEFAULT NULL");
se_db_add_field('shop_deliverytype', 'week', "char(7) DEFAULT '1111111'");
se_db_add_field('shop_deliverytype', 'max_weight', "float(10,3) unsigned DEFAULT NULL");
se_db_add_field('shop_deliverytype', 'max_volume', "int(11) unsigned DEFAULT NULL");
...
se_db_add_field('shop_tovarorder', 'modifications', "varchar(255) default NULL");
