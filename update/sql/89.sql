...
CREATE TABLE IF NOT EXISTS `permission_object` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
INSERT INTO `permission_object` (`id`, `code`, `name`, `updated_at`, `created_at`) VALUES
...
ALTER TABLE `se_user` ADD `is_manager` BOOLEAN NOT NULL DEFAULT FALSE AFTER `is_super_admin`, ADD INDEX (`is_manager`);