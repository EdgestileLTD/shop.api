CREATE TABLE IF NOT EXISTS shop_measure_weight (
...
CREATE TABLE IF NOT EXISTS shop_measure_volume (
  id int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  code varchar(255) DEFAULT NULL COMMENT 'Код по ОКЕИ',
  name varchar(255) NOT NULL,
  designation varchar(50) DEFAULT NULL COMMENT 'Условное обозначение',
...
CREATE TABLE IF NOT EXISTS shop_price_measure (
  id int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
...
INSERT INTO shop_settings(code, type, name, `default`, list_values, id_group, description, sort, enabled) VALUES
...
INSERT INTO shop_measure_volume(code, name, designation, value, is_base, `precision`) VALUES
('111', 'Кубический сантиметр', 'см3', 1.000000, 1, 0),
('112', 'Литр', 'л', 0.001000, 0, 3);

INSERT INTO shop_measure_weight(code, name, designation, value, is_base, `precision`) VALUES
